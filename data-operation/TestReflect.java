...
public class TestReflect {
    public static <T, K extends Comparable<Number> & Cloneable> Map<T, K[]> test(TestReflect p1, List<TestReflect> p2,
    	Map<String, TestReflect> p3, List<String>[] p4, Map<String, TestReflect>[] p5, List<? extends Comparable> p6,
    	Map<? extends Number, ? super TestReflect> p7, T p8, K p9
    ) { return null; }

    private static void show2(Method method) {
